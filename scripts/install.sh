...
echo -e "${PRIMARY}    __                      __           _     ${RESET}"
echo -e "${PRIMARY}   / /   ____ _____  ____ _/ /__________(_)___ ${RESET}"
echo -e "${PRIMARY}  / /   / __ \`/ __ \/ __ \`/ __/ ___/ __ / / __ \\ ${RESET}"
echo -e "${PRIMARY} / /___/ /_/ / / / / /_/ / /_/ /  / /_/ / / / / / ${RESET}"
echo -e "${PRIMARY}/_____/\__,_/_/ /_/\__, /\__/_/   \__,_/_/_/ /_/ ${RESET}"
echo -e "${PRIMARY}                  /____/                         ${RESET}"
